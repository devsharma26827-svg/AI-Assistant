"""
Cynthia Memory Store.
Manages file-based JSON persistence of user profiles, preferences, habits, 
schedules, emotional context, projects, and custom automation workflows.
"""
import json
import os
import logging
